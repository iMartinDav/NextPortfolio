...
export function AnimatedBeamMultipleOutputs({
  ...
  return (
    <div
      className={cn(
        'bg-background relative flex w-full max-w-125 items-center justify-center overflow-hidden rounded-lg border p-10 md:shadow-xl lg:max-w-full',
        className
      )}
      ref={containerRef}>
...
const Icons = {
  ...
  Nextjs: (props: IconProps) => {
    ...
    const gradientId0 = `${uniqueId}-nextjs-gradient0`;
    const gradientId1 = `${uniqueId}-nextjs-gradient1`;
    const circleId = `${uniqueId}-nextjs-circle`;
    const maskId = `${uniqueId}-nextjs-mask`;
