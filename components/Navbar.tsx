	...
	return (
		...
		>
			<div className="navbar-container">
				<Link href="/" className="navbar-brand" onClick={handleNavItemClick}>
					<Image
						className="dark"
						src="/logo.png"
						alt="logo"
				...
				<div id={navId} className={`navbar-nav ${isMenuOpen ? "flex" : ""}`}>
					{navItems.map((item) => (
						<NavItem key={item.href} {...item} onClick={handleNavItemClick} />
					))}
